...
public class AdminOrderServlet extends AbstractServlet{
    ...
    public String index(HttpServletRequest request,HttpServletResponse response)throws Exception{
        ...
        int total=ordersService.count(Integer.valueOf(userId));
        Pager pager=new Pager(total,rowPerPage,currentPage);
        pager.setUrl("/admin/order?action=index&userId="+userId);
        List<Orders> orderList=ordersService.getOrdersList(Integer.valueOf(userId), currentPage, rowPerPage);
    ...
    public String queryOrderDeatil(HttpServletRequest request,HttpServletResponse response)throws Exception{
        ...
        List<OrderDetail> orderDetailList=ordersService.getOrderDetailList(Integer.valueOf(orderId));
    ...
    public String queryAllOrder(HttpServletRequest request,HttpServletResponse response)throws Exception{
        ...
        List<Orders> orderList=ordersService.getOrdersList(null, currentPage, rowPerPage);
        request.setAttribute("orderList", orderList);
        request.setAttribute("pager", pager);
